...
<!--                <label for="search_properties" id="critlabel" style="display: --><?//= in_array($searchOption, ['city', 'years', 'title']) ? "" : "none" ?><!-- ">Критерии:</label>-->
                <select name="search_city_properties" id="search_city_properties" style="margin-top: 20px; display: <?= $searchOption == 'city' ? '' : 'none' ?> ;" >
                ...
                <select name="search_year_properties" id="search_year_properties" style="margin-top: 20px; display: <?= $searchOption == 'years' ? '' : 'none' ?> ;">
                ...
                <select name="search_title_properties" id="search_title_properties" style="margin-top: 20px; display: <?= $searchOption == 'title' ? '' : 'none' ?> ;">
